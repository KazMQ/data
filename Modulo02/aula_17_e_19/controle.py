...
try:
    ...
    if not df_roubo_veiculo_outliers_inferiores.empty:
        ...
        barras = ax[0].bar(dados_inferiores['munic'], dados_inferiores['roubo_veiculo'], color='purple')
    ...
    if not df_roubo_veiculo_outliers_superiores.empty:
        ...
        barras = ax[1].barh(dados_superiores['munic'], dados_superiores['roubo_veiculo'], color='blue')
